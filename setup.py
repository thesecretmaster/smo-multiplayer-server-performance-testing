...
server_command_string = "clang -Wall -pthread -o server -O3 server.c queues/" + args.queue + ".c backends/" + args.backend + "_backend.c"
print(server_command_string)
system(server_command_string)
client_command_string = "clang -Wall -o client -O3 client.c"
